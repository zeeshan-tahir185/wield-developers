...
export const epcProjects: EpcProject[] = [
  ...
  },
  {
    ...
    icon: "Construction",
    summary:
      "Construction of a dedicated prayer area building with a connecting pedestrian bridge — expanding capacity and connectivity at Joyland, Rawalpindi.",
    description: [
      "Wield Developers (Pvt.) Ltd. successfully executed the Construction of a Prayer Area Building along with a Connecting Bridge at Joyland, Rawalpindi, aimed at enhancing the facility's spatial capacity and improving connectivity within the existing premises. The project was undertaken to expand the usable area and provide a dedicated, well-designed prayer space for visitors and staff, while ensuring seamless pedestrian movement through the newly constructed bridge structure.",
    ...
    scope: [
      ...
      "Connecting pedestrian bridge structure",
